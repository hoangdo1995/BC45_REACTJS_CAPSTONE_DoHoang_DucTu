  ...
  return (
    <div className="container" style={{background:'#FFFCFC'}}>
      ...
      <div className="profile p-4">
        <form className="flex" onSubmit={frm.handleSubmit}>
          <div className="avatar d-flex justify-content-center">
            <img
              src={user_login?.avatar}
              alt="..."
              style={{ width: "50%", display: "block", borderRadius: "50%" }}
            />
          </div>
          <div className="infor_item row d-flex justify-content-center">
          ...
          <div className="col-md-10 d-flex justify-content-start ms-md-5">
              <div className="form-group px-4 mt-2 d-flex">
                <div>
                  <p>Gender</p>
                </div>
          ...
          <div className=" d-flex justify-content-center mt-3">
            <button className="button-submit" type="submit" style={{padding:'10px 30px 10px 28px'}} onSubmit={frm.handleSubmit}>Update</button>
          </div>
        </form>
      </div>
