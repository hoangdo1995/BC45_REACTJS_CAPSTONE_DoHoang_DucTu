    ...
    <div>
      <div className='container d-flex justify-content-between align-items-center p-4' style={{color:'white',background:'black'}}>
        ...
        <div className="nav fs-5 d-flex justify-content-between align-items-center">
          ...
          <NavLink to={'carts'} className={({isActive})=>(isActive?'text-warning ms-3':'text-white ms-3')} style={{textDecoration:'none'}}><i className="fa fa-shopping-cart"></i>({carts?.cart.length})</NavLink>
      ...
      <div className='fs-4 fw-light p-3 container' id='navigate'>
